...
final class HelpCenterDetailView: UIView {
    ...
    weak var delegate: HelpCenterDetailViewViewControllerProtocol?
    ...
    private lazy var viewData: HelpCenterDetailDataView = {
        let view = HelpCenterDetailDataView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.delegate = self
        view.isHidden = true
        return view
    ...
    private func setDataView(data: HelpCenterDetailDataViewEntity) {
        viewLoading.stopLoad()
        viewLoading.isHidden = true
        viewError.isHidden = true
...
extension HelpCenterDetailView: HelpCenterDetailViewProtocol {
...
extension HelpCenterDetailView: EErrorViewDelegate {
    func didTapReload() {
        delegate?.didTapReload()
    }
}

extension HelpCenterDetailView: HelpCenterDetailDataViewDelegate {
